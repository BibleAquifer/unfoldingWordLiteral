...
For more information about the Aquifer platform, data, and metadata formats, visit the [Aquifer Documentation repository](https://github.com/BibleAquifer/unfoldingWordLiteral).

## Sources

This edition represents v89 of the *unfoldingWord® Literal Text*, which is Copyright 2026 by unfoldingWord. The original work by *unfoldingWord* is available from unfoldingword.org/ult.
